...
const DrizzleAndLightRainGoogleIcon = ({ isBig }) => {
    return (
        <svg 
        ...
        >
            ...
            <g fill="none" fillRule="evenodd">
                ...
                <path fill="#4285F4" d="m25.732 27.732 1.768-1.768 1.768 1.768a2.5 2.5 0 1 1-3.536 0Z"></path>
            </g>
        </svg>
    );
};

export default DrizzleAndLightRainGoogleIcon;