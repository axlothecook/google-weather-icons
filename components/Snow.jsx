    ...
    return (
        ...
        >
            ...
            <g fill="none" fillRule="evenodd">
                ...
                <path stroke="#4285F4" strokeLinecap="square" d="M28 26.429v5.142m-2.227-3.857 4.454 2.572m0-2.572-4.454 2.572"></path>
            </g>
        </svg>
    );
};

export default SnowGoogleIcon;